...
export const adminFrontendOperations = [
  ...
  { method: "post", path: "/api/recheck-file", operationId: "post-api-recheck-file" },
  { method: "post", path: "/api/search-file-in-arr", operationId: "post-api-search-file-in-arr" },
  {
    method: "get",
    path: "/api/delete-webdav-item-preview",
    operationId: "get-api-delete-webdav-item-preview",
  },
  { method: "post", path: "/api/delete-webdav-item", operationId: "post-api-delete-webdav-item" },
...
export const adminApi = {
  ...
  recheckFile: "/api/recheck-file",
  searchFileInArr: "/api/search-file-in-arr",
  deleteWebdavItemPreview: "/api/delete-webdav-item-preview",
  deleteWebdavItem: "/api/delete-webdav-item",
