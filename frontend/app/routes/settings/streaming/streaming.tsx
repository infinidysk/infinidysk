      ...
      >
        ...
        >
          <div className="space-y-2">
            <Tooltip
              placement="bottom"
              content="Cache decoded segments on disk so repeat reads and seeks avoid provider traffic. Takes effect after restart."
            >
              <Toggle
        ...
        <ManagedSetting configKey="usenet.article-buffer-size">
          <div className="space-y-2">
            ...
            <Input
              {...className([
                "w-full",
                !isValidArticleBufferSize(config["usenet.article-buffer-size"]) && "input-error",
              ])}
              type="text"
              inputMode="numeric"
