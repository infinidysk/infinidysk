      ...
      <div className="space-y-4">
        ...
        <div className="rounded-lg border border-base-content/10 bg-base-200/40 p-3">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex flex-wrap items-center gap-2">
              ...
              >
                <Icon
                  name={isRunning ? "progress_activity" : "drive_file_rename_outline"}
              ...
              {isDone && (
                <>
                  ...
                  <a
                    ...
                    href={withUrlBase("/api/rename-windows-invalid-dav-paths/audit")}
                  >
                    View report
                  </a>
                </>
          ...
          <p className="mt-3 border-t border-base-content/10 pt-2.5 text-xs text-base-content/50">
            ...
            <code className="font-mono">_2</code>, <code className="font-mono">_3</code>, or later
            suffix.
          </p>
        </div>
        ...
        >
          ...
          <p>
            ...
            STRM files and symlinks target stable DavItem IDs, although browse paths and mirrored
            on-disk STRM locations will change.
          </p>
        </div>
      </div>
    </>
