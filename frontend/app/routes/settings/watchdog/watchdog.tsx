...
export function WatchdogSettings({ config, setNewConfig }: WatchdogSettingsProps) {
  ...
  return (
    <SettingsPage>
      <SettingsIntro>
        Configure how playback recovers from unavailable or stalled releases, and how alternate size
        variants are retained and selected.
      </SettingsIntro>
      ...
      <ManagedSetting
        configKeys={[
          ...
          "play.hedge-delay-seconds",
          "play.max-candidates",
          "play.max-attempts",
          "play.verify-mode",
          "play.candidate-negative-cache-minutes",
          "play.resolution-cache-ttl-hours",
          "play.prefer-subtitles",
          "grab.stall-failover-enabled",
          "grab.stall-failover-window-seconds",
          "grab.stall-failover-ceiling-seconds",
          "variants.mode",
          "variants.tolerance-pct",
          "variants.max-per-group",
          "variants.replay-strategy",
          "variants.fallback-on-failure",
          "variants.eviction-strategy",
        ...
        <div className="flex flex-col gap-4">
          ...
          >
            <Form.Group className="flex flex-col gap-2">
              <Tooltip
                placement="bottom"
                content="When off, only the chosen release is tried (legacy). When on, alternatives are tried on failure and in-flight queue items are deduped."
              >
                <Form.Check
                  type="switch"
            ...
            <Form.Group className="flex flex-col gap-2">
              ...
              <p className="m-0 text-[11px] leading-relaxed text-base-content/45">
                ...
                candidates start in parallel. Lower = more eager fallback, slightly higher provider
                load. Default 3.
              </p>
            </Form.Group>
            ...
            <Form.Group className="flex flex-col gap-2">
              ...
              />
              <p className="m-0 text-[11px] leading-relaxed text-base-content/45">
                How many candidates run at the same time in one round. Higher means faster failover
                when a candidate fails, but more simultaneous indexer requests — too many in
                parallel can look like spamming and risk a ban. Default 3.
              </p>
            </Form.Group>
            ...
            <Form.Group className="flex flex-col gap-2">
              ...
              <p className="m-0 text-[11px] leading-relaxed text-base-content/45">
                ...
                defaults (3 per batch, 10 total) it tries up to 10 candidates, a few at a time, then
                stops. Also stops sooner if the total budget runs out. Default 10.
              </p>
            </Form.Group>
            ...
            <Form.Group className="flex flex-col gap-2">
              ...
              >
                <option value="stat">
                  stat — STAT first segment (~0.2s; skips candidates flagged dead, recommended)
                </option>
              ...
              <p className="m-0 text-[11px] leading-relaxed text-base-content/45">
                `none` (the default) skips the pre-check for the fastest start; every candidate is
                enqueued right away. `stat` is a cheap NNTP check that weeds out dead releases
                before the queue commits, avoiding a re-fetch of their NZB from the indexer on every
                request.
              </p>
            </Form.Group>
            ...
            <Form.Group className="flex flex-col gap-2">
              ...
              />
              <p className="m-0 text-[11px] leading-relaxed text-base-content/45">
                How long a recently-failed release is skipped on subsequent requests, so we don't
                hammer the same dead release (and its indexer) over and over. Default 5.
              </p>
            </Form.Group>
            ...
            <Form.Group className="flex flex-col gap-2">
              ...
              />
              <p className="m-0 text-[11px] leading-relaxed text-base-content/45">
                How long play links embedded in search results stay valid. Set at or above your
                search client's result-cache lifetime (AIOStreams defaults to 7 days). Links now
                also survive restarts. Default 168 (7 days).
              </p>
            </Form.Group>
          ...
          <SettingsCard
            ...
            description={
              <>
                Set aside candidates that stop progressing and try the next one without recording
          ...
          >
            <Form.Group className="flex flex-col gap-2">
              <Tooltip
                placement="bottom"
                content="When a candidate stops progressing, set it aside and try the next one without recording it as failed. On by default."
              >
                <Form.Check
                  type="switch"
            ...
            <Form.Group className="flex flex-col gap-2">
              ...
              />
              <p className="m-0 text-[11px] leading-relaxed text-base-content/45">
                A candidate that has started but reported no progress for this many seconds is set
                aside. A candidate that keeps reporting progress is never set aside. Default 2.
              </p>
            </Form.Group>
          ...
          >
            <Form.Group className="flex flex-col gap-2">
              ...
              >
                <option value="off">
                  off — always reuse existing, biggest copy (today's behavior)
                </option>
                <option value="smart">
                  smart — reuse if size is close enough, else fetch the new variant
                </option>
                <option value="collect-all">
                  collect-all — every meaningfully different size adds a new copy
                </option>
              </Form.Select>
              <p className="m-0 text-[11px] leading-relaxed text-base-content/45">
                `smart` is the recommended default once enabled. `collect-all` adds a new copy for
                every distinct size you pick (no near-exact match) — usually fine since files are
                mounted, not stored locally; only the metadata grows.
              </p>
            </Form.Group>
            ...
            <Form.Group className="flex flex-col gap-2">
              ...
              />
              <p className="m-0 text-[11px] leading-relaxed text-base-content/45">
                `smart` mode only. Existing copy is reused if its size is within ±N% of what you
                selected. Outside that → fetch the new variant and keep both. Default 25 (generous
                to absorb indexer-vs-actual size drift).
              </p>
            </Form.Group>
            ...
            <Form.Group className="flex flex-col gap-2">
              ...
              />
              <p className="m-0 text-[11px] leading-relaxed text-base-content/45">
                Cap on how many size copies of the same item to keep at once. When the cap is hit,
                the eviction strategy below decides which to drop. Set to 0 for unlimited. Default
                3.
              </p>
            </Form.Group>
            ...
            <Form.Group className="flex flex-col gap-2">
              ...
              >
                <option value="closest-to-click">
                  closest-to-selection — match the size I picked (recommended)
                </option>
                <option value="largest">
                  largest — always pick the biggest copy, ignore my selection
                </option>
                <option value="smallest">
                  smallest — always pick the smallest copy, ignore my selection
                </option>
              </Form.Select>
              <p className="m-0 text-[11px] leading-relaxed text-base-content/45">
            ...
            <Form.Group className="flex flex-col gap-2">
              ...
              >
                ...
                <option value="largest-first">
                  largest-first — drop biggest first, keep small copies
                </option>
                <option value="smallest-first">
                  smallest-first — drop smallest first, keep big copies
                </option>
                <option value="never">
                  never — never auto-remove; new copies exceed cap and stay
                </option>
              </Form.Select>
              <p className="m-0 text-[11px] leading-relaxed text-base-content/45">
                Decides which copy is removed when `max copies per group` is hit. LRU is the safe
                default. `never` means you remove copies manually from the History view.
              </p>
            </Form.Group>
            ...
            <Form.Group className="flex flex-col gap-2">
              ...
              />
              <p className="m-0 text-[11px] leading-relaxed text-base-content/45">
                Eviction skips any copy used within the last N seconds. Safety net so we never
                remove an item that's still being accessed. Default 60.
              </p>
            </Form.Group>
          </SettingsCard>
        </div>
...
export function isWatchdogSettingsUpdated(
  config: Record<string, string>,
  newConfig: Record<string, string>,
) {
  return (
    config["play.watchdog-enabled"] !== newConfig["play.watchdog-enabled"] ||
    ...
    config["play.candidate-negative-cache-minutes"] !==
      newConfig["play.candidate-negative-cache-minutes"] ||
    ...
    config["grab.stall-failover-window-seconds"] !==
      newConfig["grab.stall-failover-window-seconds"] ||
    config["grab.stall-failover-ceiling-seconds"] !==
      newConfig["grab.stall-failover-ceiling-seconds"] ||
    ...
    config["variants.eviction-active-grace-seconds"] !==
      newConfig["variants.eviction-active-grace-seconds"]
  );
}
