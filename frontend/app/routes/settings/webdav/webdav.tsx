...
export function WebdavSettings({ config, setNewConfig }: WebdavSettingsProps) {
    return (
        <SettingsPage>
            <SettingsIntro>
                Configure WebDAV credentials and choose how mounted content appears to filesystem
                clients and the Dav Explorer.
            </SettingsIntro>
                ...
                >
                    <ManagedSetting configKey="webdav.user">
                        <div className="space-y-2">
                            <label className="block text-sm font-medium text-base-content" htmlFor="webdav-user-input">
                                WebDAV User
                            </label>
                            <Input
                            ...
                            <p className="text-[11px] leading-relaxed text-base-content/45" id="webdav-user-help">
                                Use this username to connect to WebDAV. Only letters, numbers, dashes,
                    ...
                    <ManagedSetting configKey="webdav.pass">
                        <div className="space-y-2">
                            <label className="block text-sm font-medium text-base-content" htmlFor="webdav-pass-input">
                                WebDAV Password
                            </label>
                            <Input
                                className="w-full"
