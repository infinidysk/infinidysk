...
public class GetOverviewStatsThroughputTests
{
    ...
    public void BuildThroughputFromMinutes_SumsBytesFetchedIntoBuckets()
    {
        ...
        var minutes = new[]
        {
            (m0, 10L, 4L, 3L, 1L, 0L, 100L, 1_000L),
            (m1, 5L, 2L, 1L, 0L, 2L, 50L, 500L),
            (m1, 1L, 1L, 0L, 0L, 0L, 10L, 250L), // same minute bucket as m1 when bucketSize=minute
        };
        ...
        Assert.Equal(3, points[0].QueueArticles);
        ...
        Assert.Equal(1, points[1].QueueArticles);
    ...
    public void BuildThroughputFromHourly_PreservesProviderBytesFetched()
    {
        ...
        var hours = new[]
        {
            (h0, 20L, 8L, 5L, 2L, 1L, 4_000L),
            (h1, 8L, 0L, 8L, 0L, 0L, 1_500L),
        };
        var sessions = new[]
        {
            (h0 + 30_000, 200L),
    ...
    public void BuildThroughputFromMinutes_AggregatesAcrossLargerBuckets()
    {
        ...
        var minutes = new[]
        {
            (start, 1L, 1L, 0L, 0L, 0L, 0L, 100L),
            (start + OneMinute, 1L, 0L, 1L, 0L, 0L, 0L, 250L),
            (start + OneHour, 1L, 1L, 0L, 0L, 0L, 0L, 400L),
        };
