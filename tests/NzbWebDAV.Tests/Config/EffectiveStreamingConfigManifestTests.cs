...
public sealed class EffectiveStreamingConfigManifestTests
{
    ...
    public void Defaults_MatchCurrentTypedGetters()
    {
        ...
        Assert.True(document.Connections.ReadStartWarmupEnabled);
    ...
    [
        ...
        "streaming.connectionOpenTimeoutSeconds",
        "streaming.finiteRangeSchedulerEnabled",
        "connections",
        ...
        "source.streaming.connectionOpenTimeoutSeconds",
        "source.streaming.finiteRangeSchedulerEnabled",
        "source.connections",
