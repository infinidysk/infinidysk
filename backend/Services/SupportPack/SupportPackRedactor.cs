...
internal sealed partial class SupportPackRedactor
{
    ...
    [GeneratedRegex(@"(?<![A-Za-z0-9])(?:\[(?:[0-9A-Fa-f]{1,4}:){7}[0-9A-Fa-f]{1,4}\]|(?<!:)(?:[0-9A-Fa-f]{1,4}:){7}[0-9A-Fa-f]{1,4}(?!:)|\[[0-9A-Fa-f:.]*[A-Fa-f][0-9A-Fa-f:.]*\]|[0-9A-Fa-f]*::[0-9A-Fa-f:]*|[0-9A-Fa-f]*[A-Fa-f][0-9A-Fa-f]*(?::[0-9A-Fa-f]+)+)(?![A-Za-z0-9])")]
