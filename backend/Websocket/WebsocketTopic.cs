...
public class WebsocketTopic
{
    ...
    public static readonly WebsocketTopic SampleCleanupTaskProgress = new("sctp", TopicType.State);
    ...
    public static readonly WebsocketTopic BandwidthUsage = new("bwu", TopicType.State);
    public static readonly WebsocketTopic PrefetchCacheStatus = new("pcs", TopicType.State);
    public static readonly WebsocketTopic ProviderUsageStats = new("pus", TopicType.State);
